...
- **Parcelamento tem valor mínimo, e ele é do Mercado Pago**: cerca de **R$ 5,35 por parcela** (medido: R$ 21,40 dá 4x, R$ 53,50 dá 10x, R$ 107,00 dá 18x). Em compra pequena o MP devolve só 1x e o seletor não aparece — por isso a tela mostra um aviso explicando o mínimo (`PARCELA_MINIMA` em [assets/pagamento-cartao.js](assets/pagamento-cartao.js)), em vez de simplesmente esconder o campo e parecer defeito.
