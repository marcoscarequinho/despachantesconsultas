...
- **ATPV-e — REMOVIDO** (10/09/2026): as rotas `/api/v1/atpve-<uf>/*` saíram do ar junto com todo o fluxo de Intenção de Venda, na migração do fornecedor anterior para o portaldespachantes.online, que não expõe rota de ATPV-e. Quem chamar recebe 404. Reativar exige um fornecedor com API de ATPV-e.
